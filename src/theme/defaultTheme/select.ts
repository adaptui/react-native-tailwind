  ...
  base: {
    ...
    size: {
      sm: {
        ...
        withoutAddon: "px-2",
        text: "text-cxs font-normal",
        prefix: "h-[26px] pl-2 pr-1.5",
        suffix: "h-[26px] pr-2 pl-1.5",
      },
      md: {
        common: "h-[30px] rounded-lg",
        withoutAddon: "px-2.5",
        text: "text-sm font-normal",
        prefix: "h-[30px] pl-2.5 pr-1.5",
        suffix: "h-[30px] pr-2.5 pl-1.5",
      },
      lg: {
        common: "h-9 rounded-[10px]",
        withoutAddon: "px-3",
        text: "text-sm font-normal",
        prefix: "h-9 pl-3 pr-1.5",
        suffix: "h-9 pr-3 pl-1.5",
      },
      xl: {
        common: "h-11 rounded-xl",
        withoutAddon: "px-3",
        text: "text-base font-normal",
        prefix: "h-11 pl-3 pr-2",
        suffix: "h-11 pr-3 pl-2",
      },
    },
    variant: {
      outline: {
